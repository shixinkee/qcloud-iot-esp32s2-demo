...
static void _init_data_template(void)
{
    ...
    sg_DataTemplate[2].data_property.key = "hue";
    sg_DataTemplate[2].data_property.data = &sg_ProductData.m_hue;
    sg_DataTemplate[2].data_property.type = TYPE_TEMPLATE_INT;

    sg_ProductData.m_saturation = 0;
    sg_DataTemplate[3].data_property.key = "saturation";
    sg_DataTemplate[3].data_property.data = &sg_ProductData.m_saturation;
    sg_DataTemplate[3].data_property.type = TYPE_TEMPLATE_INT;

    sg_ProductData.m_lightness = 0;
    sg_DataTemplate[4].data_property.key = "lightness";
    sg_DataTemplate[4].data_property.data = &sg_ProductData.m_lightness;
    ...
    sg_DataTemplate[5].data_property.key = "name";
    sg_DataTemplate[5].data_property.data = sg_ProductData.m_name;
    sg_DataTemplate[5].data_property.data_buff_len = MAX_STR_NAME_LEN;
    sg_DataTemplate[5].data_property.type = TYPE_TEMPLATE_STRING;
};
/*-----------------data config end  -------------------*/
...
static int _get_sys_info(void *handle, char *pJsonDoc, size_t sizeOfBuffer)
{
    ...
    DeviceProperty platform_info[] = {
        ...
        {.key = "module_softinfo", .type = TYPE_TEMPLATE_STRING, .data = "1.1.6"},
        {.key = "fw_ver", .type = TYPE_TEMPLATE_STRING, .data = "1.1.6"},
...
static void _get_status_reply_ack_cb_new(void *pClient, Method method, ReplyAck replyAck, const char *pReceivedJsonDocument, void *pUserdata)
{
    ...
    {
        ESP_LOGE(__FILE__, "get_status error");
    }
...
int qcloud_iot_explorer_demo(eDemoType eType)
{
    ...
    rc = enable_ota_task(&sg_devInfo, IOT_Template_Get_MQTT_Client(client), "1.1.6");
    if (rc)
